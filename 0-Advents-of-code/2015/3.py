...
position_robot = (0, 0)
houses_2 = set()
for i, mov in enumerate(input):
    position1 = next_house(position1, mov)
    houses.add(position1)

    if i % 2 == 0:
        position_santa = next_house(position_santa, mov)
        houses_2.add(position_santa)
    else:
        position_robot = next_house(position_robot, mov)
        houses_2.add(position_robot)

print("Solution 1: ", len(houses))
print("Solution 2: ", len(houses_2))
