...
winning_ways_runs = []
for time, record in zip(max_time, record_distance):
    winning_ways_runs.append(winning_ways(time, record))

print("Solution 1: ", int(math.prod(winning_ways_runs)))

max_time = 51699878
record_distance = 377117112241505
print("Solution 2: ", winning_ways(max_time, record_distance))
